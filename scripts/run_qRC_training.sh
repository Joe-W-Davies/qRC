...
for var in "probeCovarianceIetaIphi";
do
	...
	#qsub -q all.q -l h_vmem=6G job_train_qRC_data.sh ${configSS} ${var} ${q} ${N_evts} ${EBEE}
        ...
        mkdir -p "${PWD}/Jobs/Data/${var}"
	qsub -q hep.q -o "${PWD}/Jobs/Data/${var}/Stdjob.out" -e "${PWD}/Jobs/Data/${var}/Stdjob.err" -l h_vmem=6G job_train_qRC_data.sh ${configSS} ${var} ${q} ${N_evts} ${EBEE}
    done
done
...
#	qsub -q hep.q -l h_vmem=6G job_train_qRC_I_data.sh ${configPI} ${var} ${q} ${N_evts} ${EBEE}
#    done
#done
#
...
#	qsub -q hep.q -l h_vmem=6G job_train_qRC_I_data.sh ${configCI} ${var} ${q} ${N_evts} ${EBEE}
#    done
#done
#

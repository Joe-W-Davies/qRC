...
#NOTE: rename vars for ReReco example
##nominal
...
##re-doing Phi and eta Width
for var in "probeEtaWidth_Sc" "probePhiWidth_Sc";
do
...
#	#qsub -q all.q -l h_vmem=6G job_train_qRC_data.sh ${configSS} ${var} ${q} ${N_evts} ${EBEE}
        ...
        mkdir -p "${PWD}/Jobs/Data/${var}"
       qsub -q hep.q -o "${PWD}/Jobs/Data/${var}/Stdjob_${q}.out" -e "${PWD}/Jobs/Data/${var}/Stdjob_${q}.err" -l h_vmem=6G job_train_qRC_data.sh ${configSS} ${var} ${q} ${N_evts} ${EBEE}
    done
done
...
#        mkdir -p "${PWD}/Jobs/Data/${var}"
#        mkdir -p "${PWD}/Jobs/Data/${var}"
#	qsub -q hep.q -o "${PWD}/Jobs/Data/${var}/Stdjob_${q}.out" -e "${PWD}/Jobs/Data/${var}/Stdjob_${q}.err" -l h_vmem=6G job_train_qRC_I_data.sh ${configPI} ${var} ${q} ${N_evts} ${EBEE}
#    done
#done
#
...
#        mkdir -p "${PWD}/Jobs/Data/${var}"
#        mkdir -p "${PWD}/Jobs/Data/${var}"
#	qsub -q hep.q -o "${PWD}/Jobs/Data/${var}/Stdjob_${q}.out" -e "${PWD}/Jobs/Data/${var}/Stdjob_${q}.err" -l h_vmem=6G job_train_qRC_I_data.sh ${configCI} ${var} ${q} ${N_evts} ${EBEE}
#    done
#done
#
